...
const educationItems: EducationItem[] = [
  {
    ...
    status: 'completed',
    description: 'Especialización en desarrollo de sistemas, bases de datos y arquitectura de software empresarial.',
  ...
  },
  {
    ...
    status: 'completed',
    description: 'Formación sólida en optimización de procesos, gestión de operaciones y análisis de sistemas productivos.',
    icon: <GraduationCap className="h-5 w-5" />
  },
  {
    type: 'certification',
    ...
    status: 'completed',
    description: 'Certificación especializada en implementación y administración de sistemas SAP para empresas.',
  ...
  },
  {
    ...
    status: 'completed',
    description: 'Certificación profesional en desarrollo de aplicaciones de Business Intelligence con QlikView.',
    icon: <Award className="h-4 w-4" />
  },
  {
    type: 'certification',
    ...
    status: 'completed',
    description: 'Especialización en administración, optimización y seguridad de bases de datos Microsoft SQL Server.',
    icon: <Award className="h-4 w-4" />
  }
]
    ...
    <section id="education" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
      ...
      <div>
        <p className="mb-8 text-slate-400 leading-relaxed">
          Mi formación académica y certificaciones profesionales me han proporcionado una base sólida en ingeniería, 
          complementada con especializaciones técnicas que me permiten liderar proyectos de tecnología e innovación.
        </p>
        ...
        <div className="mt-12 p-6 rounded-lg bg-slate-800/30 border border-slate-200/10">
          ...
          <p className="text-sm text-slate-400 leading-relaxed mb-4">
            Mi compromiso con el aprendizaje continuo me mantiene actualizado en las últimas tecnologías y mejores 
            prácticas de la industria. Regularmente participo en capacitaciones, webinars y conferencias tecnológicas 
            para estar a la vanguardia de las tendencias del sector.
          </p>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="flex items-center">
              <div className="text-2xl font-bold text-teal-300 mr-3">2</div>
              <div className="text-sm text-slate-400">Títulos Universitarios</div>
            </div>
            <div className="flex items-center">
              <div className="text-2xl font-bold text-amber-300 mr-3">3</div>
              <div className="text-sm text-slate-400">Certificaciones Técnicas</div>
            </div>
          </div>
        </div>
      </div>
