...
const projects: Project[] = [
  {
    ...
    description: "Plataforma completa de comercio electrónico con funcionalidades avanzadas de gestión de inventario, procesamiento de pagos seguros con Stripe, y panel administrativo. Incluye sistema de autenticación, carrito de compras, y dashboard analítico.",
    image: "/project1.jpg",
  ...
  },
  {
    ...
    description: "Aplicación de gestión de tareas con colaboración en tiempo real, notificaciones push, y sincronización en múltiples dispositivos. Implementa WebSockets para actualizaciones instantáneas y tiene soporte offline.",
    image: "/project2.jpg",
    technologies: ["React", "Node.js", "Socket.io", "MongoDB", "Express", "PWA"],
    links: {
  ...
  },
  {
    ...
    description: "Sitio web personal desarrollado con Next.js y TypeScript, optimizado para SEO y performance. Incluye blog integrado con MDX, sistema de comentarios, y despliegue automático con GitHub Actions.",
    image: "/project3.jpg",
    technologies: ["Next.js", "TypeScript", "MDX", "Tailwind CSS", "Framer Motion"],
    links: {
  ...
  },
  {
    ...
    description: "Dashboard meteorológico con visualizaciones interactivas, pronósticos extendidos, y mapas climáticos. Integra múltiples APIs meteorológicas y utiliza D3.js para gráficos dinámicos.",
    image: "/project4.jpg",
  ...
  },
  {
    ...
    description: "Aplicación de chat en tiempo real con salas privadas, compartir archivos, emojis personalizados, y historial de mensajes. Implementa autenticación JWT y cifrado de mensajes.",
    image: "/project5.jpg",
  ...
  {
    title: "API RESTful",
    description: "API robusta para gestión de contenido con autenticación, autorización por roles, rate limiting, documentación automática con Swagger, y tests unitarios completos.",
    image: "/project6.jpg",
    technologies: ["NestJS", "TypeScript", "PostgreSQL", "Swagger", "Jest", "Docker"],
    links: {
